...
let favoriteFoods = ['Rice', 'Pasta', 'Steak', 'Packed Fish'];
...
favoriteFoods.push('Chicken Salad');
console.log('Added food at the end', favoriteFoods);
...
favoriteFoods.unshift('Chapati')
console.log(`Added favortie food at the beginning: ${favoriteFoods}`)
